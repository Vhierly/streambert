...
const BLOCKED_HOSTS = [
  ...
  // ── Ad/tracker domains for alternative streaming sources ───────────────────
  // VidLink ad/tracker subdomains (NOT the main player domain)
  "*://ads.vidlink.pro/*",
  "*://track.vidlink.pro/*",
  "*://analytics.vidlink.pro/*",
  "*://doubleclick.vidlink.pro/*",
  "*://googletagmanager.vidlink.pro/*",
  "*://adserver.vidlink.pro/*",
  // VidSpark ad/tracker subdomains
  "*://ads.vidspark.to/*",
  "*://track.vidspark.to/*",
  "*://analytics.vidspark.to/*",
  "*://doubleclick.vidspark.to/*",
  "*://googletagmanager.vidspark.to/*",
  "*://adserver.vidspark.to/*",
  // VidFast ad/tracker subdomains
  "*://ads.vidfast.vc/*",
  "*://track.vidfast.vc/*",
  "*://analytics.vidfast.vc/*",
  ...
  "*://analytics.vidphantom.com/*",
  "*://doubleclick.vidphantom.com/*",
  "*://googletagmanager.vidphantom.com/*",
  "*://adserver.vidphantom.com/*",
  // CineXtream ad/tracker subdomains
  "*://ads.cinextream.cc/*",
  "*://track.cinextream.cc/*",
  "*://analytics.cinextream.cc/*",
  "*://doubleclick.cinextream.cc/*",
  "*://googletagmanager.cinextream.cc/*",
  "*://adserver.cinextream.cc/*",
  // VidSrc3 ad/tracker subdomains
  "*://ads.vidsrc3.created.app/*",
  "*://track.vidsrc3.created.app/*",
  "*://analytics.vidsrc3.created.app/*",
